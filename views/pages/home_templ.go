...
func homeBody(v viewdata.HomeView) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if v.LoggedIn && v.CalendarErr == "" && len(v.Calendars) > 0 {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<div class=\"grid gap-4 sm:grid-cols-2\"><div><label for=\"start\" class=\"block text-sm font-medium text-slate-800\">Start date</label> <input id=\"start\" type=\"date\" name=\"start\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "\" required class=\"mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm shadow-sm\"></div><div><label for=\"end\" class=\"block text-sm font-medium text-slate-800\">End date</label> <input id=\"end\" type=\"date\" name=\"end\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
